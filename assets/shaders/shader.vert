...
layout(location = 4) in vec4 inTangent; // 接收切线
...
layout(location = 4) out vec4 fragTangent; // 传递切线给片段着色器计算切线空间的法线贴图
...
void main() {
    ...
    fragTangent = vec4(normalMatrix * inTangent.xyz, inTangent.w); // 透传切线向量以便在片段着色器中计算切线空间的法线贴图
